...
def get_HTHF(i, v):
    HT = {"HT001": "개별난방", "HT002": "중앙난방", "HT003": "개별냉난방", "HT004": "중앙냉난방", "HT005": "지역난방", "HT006": "지역냉난방", "HT000": "미노출"}
    HF = {"HF001": "도시가스", "HF002": "열병합", "HF003": "기름", "HF004": "전기", "HF005": "심야전기", "HF006": "태양열", "HF007": "LPG", "HF008": "지열", "HF000": "미노출"}
    if i == "T":
        a = HT.get(v)
    else:
        a = HF.get(v)
